...
class SGDFunctionApproximator:
    ...
    def __init__(self, env):
        ...
        # Used to convert a state to a featurized represenatio
...
class Tamer:
    ...
    http://www.cs.utexas.edu/users/bradknox/kcap09/Knox_and_Stone,_K-CAP_ f  9.html
    """
    def __init__(
        self,
        env,
                ...
                if not self.tame:
                    ...
                    while time.time() < now + self.ts_len:
                        ...
                        if self.choice == 0 :
                            ...
                            human_reward= disp.get_speech_feedback()
                        elif self.choice == 2  :
                            human_reward= disp.get_gestures_feedback()


                        #print("Huan ",human_reward)
    ...
    def evaluate(self, n_episodes=100):
        ...
        plt.title("Evaluation mean rewards over 20 episodes")
        plt.plot(avg)
        plt.show()
        return avg_reward
